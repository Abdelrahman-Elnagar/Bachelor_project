#!/usr/bin/env python3
"""
Script to extract href links from soil temperature HTML file and download them.
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler('download_soil_temperature_files.log'),
...
def main():
    """Main function"""
    parser = argparse.ArgumentParser(description='Download soil temperature files from HTML index')
    parser.add_argument('--html-file', default='soil_temperature/Index of _climate_environment_CDC_observations_germany_climate_hourly_soil_temperature_historical_.html',
                       help='Path to HTML file containing links')
    parser.add_argument('--download-dir', default='soil_temperature',
    ...
    logging.info("Starting soil temperature file download process...")
