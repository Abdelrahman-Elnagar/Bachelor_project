#!/usr/bin/env python3
"""
Script to extract href links from solar HTML file and download them.
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler('download_solar_files.log'),
...
def main():
    """Main function"""
    parser = argparse.ArgumentParser(description='Download solar files from HTML index')
    parser.add_argument('--html-file', default='solar+/Index of _climate_environment_CDC_observations_germany_climate_hourly_solar_.html',
                       help='Path to HTML file containing links')
    parser.add_argument('--download-dir', default='solar+',
    ...
    logging.info("Starting solar file download process...")
