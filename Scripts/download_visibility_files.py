#!/usr/bin/env python3
"""
Script to extract href links from visibility HTML file and download them.
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler('download_visibility_files.log'),
...
def main():
    """Main function"""
    parser = argparse.ArgumentParser(description='Download visibility files from HTML index')
    parser.add_argument('--html-file', default='visibility/Index of _climate_environment_CDC_observations_germany_climate_hourly_visibility_historical_.html',
                       help='Path to HTML file containing links')
    parser.add_argument('--download-dir', default='visibility',
    ...
    logging.info("Starting visibility file download process...")
