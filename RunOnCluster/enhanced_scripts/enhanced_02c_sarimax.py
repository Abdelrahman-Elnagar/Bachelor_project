...
-----------------------
SARIMAX ONLY - WITH DETAILED RESIDUAL TRACKING
"""
...
def train_and_eval(params, data):
    ...
    try:
        ...
        return {'loss': rmse, 'status': STATUS_OK, 'model': model_fit, 'preds': preds}
...
def append_results(experiment, best_params, metrics):
    filename = f"{OUTPUT_DIR}/results_sarimax.txt"
    header = ""
...
if __name__ == "__main__":
    print("=" * 80)
    print("   SARIMAX ONLY (WITH DETAILED TRACKING)")
    print("=" * 80)
