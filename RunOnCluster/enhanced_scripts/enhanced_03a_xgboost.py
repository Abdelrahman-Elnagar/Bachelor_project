...
-----------------------
XGBOOST ONLY - WITH DETAILED RESIDUAL TRACKING
"""
...
def train_and_eval(params, X_train, y_train, X_test, y_test):
    model = xgb.XGBRegressor(**params, n_jobs=-1, random_state=42, early_stopping_rounds=50)
...
def append_results(experiment, best_params, metrics):
    filename = f"{OUTPUT_DIR}/results_xgboost.txt"
    header = ""
    if not os.path.exists(filename):
        header = "==================================================\nMODEL: XGBOOST (Aggressive Tuning)\n==================================================\n\n"
...
if __name__ == "__main__":
    print("="*80)
    print("   XGBOOST ONLY (WITH DETAILED TRACKING)")
    print("="*80)
