...
print("="*60)
print("TRAINING MODELS ON WIND GENERATION (NO WSI)")
print("="*60)
...
# Save ARIMA model
with open('forecasting/models/arima_wind_no_wsi_model.pkl', 'wb') as f:
    pickle.dump(arima_fit, f)
print("ARIMA wind (no WSI) model saved\n")
...
# Save SARIMA model
with open('forecasting/models/sarima_wind_no_wsi_model.pkl', 'wb') as f:
    pickle.dump(sarima_fit, f)
print("SARIMA wind (no WSI) model saved\n")
...
# Save to CSV
results_df.to_csv('forecasting/models/results_wind_no_wsi.csv', index=False)
print("Results saved to results_wind_no_wsi.csv\n")

print("WIND (NO WSI) - ARIMA Metrics:")
arima_metrics = calculate_metrics(test, arima_pred)
for metric, value in arima_metrics.items():
    print(f"{metric}: {value:.6f}")
print()

print("WIND (NO WSI) - SARIMA Metrics:")
...
print("="*60)
print("WIND (NO WSI) TRAINING COMPLETE!")
print("="*60)
