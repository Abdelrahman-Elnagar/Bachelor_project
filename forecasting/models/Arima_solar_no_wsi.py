...
print("="*60)
print("TRAINING MODELS ON SOLAR GENERATION (NO WSI)")
print("="*60)
...
# Save ARIMA model
with open('forecasting/models/arima_solar_no_wsi_model.pkl', 'wb') as f:
    pickle.dump(arima_fit, f)
print("ARIMA solar (no WSI) model saved\n")
...
# Save SARIMA model
with open('forecasting/models/sarima_solar_no_wsi_model.pkl', 'wb') as f:
    pickle.dump(sarima_fit, f)
print("SARIMA solar (no WSI) model saved\n")
...
# Save to CSV
results_df.to_csv('forecasting/models/results_solar_no_wsi.csv', index=False)
print("Results saved to results_solar_no_wsi.csv\n")

print("SOLAR (NO WSI) - ARIMA Metrics:")
arima_metrics = calculate_metrics(test, arima_pred)
for metric, value in arima_metrics.items():
    print(f"{metric}: {value:.6f}")
print()

print("SOLAR (NO WSI) - SARIMA Metrics:")
...
print("="*60)
print("SOLAR (NO WSI) TRAINING COMPLETE!")
print("="*60)
